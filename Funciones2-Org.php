...
//*************************
//Consulta  a la BD
$query1 = oci_parse($conOracle1, "SELECT ID_REPORTE, TO_CHAR(FECHA_AVISO, 'HH24:MI DD-MON-YYYY') AS FECHA,CLAVE_LUGAR,CR, NIVEL, EFECTO_ADVERSO, OBSERVACIONES,RESPUESTA_INSTITUCIONAL,SELECCION,ATENDIDO from cenacom.reportes where rownum<=5 ORDER BY ID_REPORTE DESC");
	if(!$query1){
