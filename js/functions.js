...
function SeleccionandoCombo_2(combo1, combo2, comboC){
	combo2 = document.getElementById(combo2); //con jquery: $("#"+combo2)[0];
	LimpiarCombo(combo2);
	//console.log(combo1.options[combo1.selectedIndex].value);
	combo1.value=combo1.options[combo1.selectedIndex].value;
...
function escribeLayerLugar(cuenta, tipo){
	...
	cuenta++;
    document.getElementById('agregarLugar').innerHTML = '<a href="#lugar" onclick="agregarLugar(\'lugar\','+cuenta+');"> Agregar lugar</a>';
...
function agregarLugar(bloque, cuenta){
		numeroLugares=50;//maxlength=500 implica solo 8 lugares ya que el tamanio del campo es de 4000 Bytes		
