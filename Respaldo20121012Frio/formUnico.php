...
<title>Reporte &Uacute;nico</title>
...
?>
	<br/>	
	<br/>
	Resum&eacute;n de da&ntilde;os materiales: <br/>
	<textarea id="unicoDanosMateriales" name="unicoDanosMateriales" title="Da&ntilde;os Materiales" rows="3" cols="50"></textarea>	
	<br/>
	<br/>
	Declaratoria: <br/>
