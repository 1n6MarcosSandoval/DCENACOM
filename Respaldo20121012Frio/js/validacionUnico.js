...
function valida(){
	valuesAnidados_nivel2('link','T','unicoLinks');	
	/*
	//No nulos
	...
	if(noNulo('unicoDanosMateriales')){
		return 0;
	}
	...
	if(noNumero('unicoPersonasAfectadas')){		
		return 0;
	}else if(noNegativo('unicoPersonasAfectadas')){
		return 0;
	}
