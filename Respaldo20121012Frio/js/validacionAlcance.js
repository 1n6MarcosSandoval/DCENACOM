...
function valida(){
	valuesAnidados_nivel2('link','T','alcanceLinks');	
	/*
	//No nulos
	...
	if(noNulo('alcanceAreasAfectadas')){
		return 0;
	}
	...
	if(noNulo('alcanceDanosMateriales')){
		return 0;
	}
	...
	if(noNumero('alcancePersonasAfectadas')){		
		return 0;
	}else if(noNegativo('alcancePersonasAfectadas')){
		return 0;
	}
	...
	if(!validarFecha('alcanceFechaFenomeno')){
		return 0;
	}
