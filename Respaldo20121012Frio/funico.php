...
$sql02="VALUES(";
$sql04=")";
$sql03=$idEvento.","."'Unico'".","."'0'".",".$unicoFechaHoraReportaSQL.",".$unicoFechaHoraReportaSQL.",'".$_POST["unicoDanosMateriales"]."','".$unicoInstitucionesLista."','".$_POST["unicoObservaciones"]."','".$_POST["unicoDeclaratoria"]."'";
...
$escribeOracle=oci_parse($conOracle,$sql0);
oci_execute($escribeOracle);


//ESCRIBE EN LA BD QUERY DEL REPORTE
$escribeOracle=oci_parse($conOracle,$sql);
oci_execute($escribeOracle);


include 'visual_download.php?cr='.$CRregistrado;
