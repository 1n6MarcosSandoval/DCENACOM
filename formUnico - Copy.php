...
<br/>
	...
	<!--<input type="hidden" name="unicoOtroLugar" id="unicoOtroLugar">-->
	<input type="hidden" name="unicoEstado" id="unicoEstado" value="0">
	<input type="hidden" name="unicoMunicipio" id="unicoMunicipio" value="0">
	<input type="hidden" name="unicoLocalidad" id="unicoLocalidad" value="0">
	
<!-- FIN Elementos de Lugar -->
	<br/>
	<br/>
...
<?php
	...
	comboQueryJSMultiple($query,"ID_TURNO", 'NOMBRE', 'unicoAutoresTurnoC', 'unicoAutoresC', 'autores', 'Seleccionar turno','Autores');
?>
