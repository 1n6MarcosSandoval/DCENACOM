...
<?php
	...
	$alcanceMunicipio=obtenerValorQuery($conOracle,'CENACOM', 'REPORTES', 'CR', $crReal, 'MUNICIPIO');
	$alcanceLocalidad=obtenerValorQuery($conOracle,'CENACOM', 'REPORTES', 'CR', $crReal, 'LOCALIDAD');
	$alcanceOtroLugar=obtenerValorQuery($conOracle,'CENACOM', 'REPORTES', 'CR', $crReal, 'OTRO_LUGAR');
...
?>
	...
	<input type="hidden" name="alcanceLocalidad" id="alcanceLocalidad" value="<?php echo $alcanceLocalidad; ?>">
	<input type="hidden" name="alcanceOtroLugar" id="alcanceOtroLugar" value="<?php echo $alcanceOtroLugar; ?>">
...
<?php
	...
	comboQueryJSMultiple($query,"ID_TURNO", 'NOMBRE', 'alcanceAutoresTurnoC', 'alcanceAutoresC', 'autores', 'Seleccionar turno','Autores');	
?>
	<input type="hidden" name="alcanceAutores" id="alcanceAutores" value="0">
	<input type="hidden" name="alcanceAutoresTurno" id="alcanceAutoresTurno" title="alcanceAutoresTurno hidden" value="0">
	<br/>
	<br/>
<?php
