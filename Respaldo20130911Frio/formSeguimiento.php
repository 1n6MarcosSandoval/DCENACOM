...
?>
	...
	<input type="hidden" name="seguimientoLocalidad" id="seguimientoLocalidad" value="<?php echo $seguimientoLocalidad; ?>">
	<input type="hidden" name="seguimientoOtroLugar" id="seguimientoOtroLugar" value="<?php echo $seguimientoOtroLugar; ?>">
...
<?php
	...
	comboQueryJSMultiple($query,"ID_TURNO", 'NOMBRE', 'seguimientoAutoresTurnoC', 'seguimientoAutoresC', 'autores', 'Seleccionar turno','Autores');
?>
	<input type="hidden" name="seguimientoAutores" id="seguimientoAutores" value="0">
	<input type="hidden" name="seguimientoAutoresTurno" id="seguimientoAutoresTurno" title="seguimientoAutoresTurno hidden" value="0">
	<br/>
	<br/>
<?php
