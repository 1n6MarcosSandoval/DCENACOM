...
$sql37="0"." ,"."0"." ,".$_POST["alcanceAutoresTurno"].",".$_POST["alcanceTipoFenomeno"].",'".$alcanceOtroLugar."' ,".$_POST["crRelacionado"]." ,".$alcanceFechaHoraFenomenoSQL." ,".$alcanceFechaHoraFenomenoSQL;
