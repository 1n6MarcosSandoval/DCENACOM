...
?>
	...
	<br/>
	Personas afectadas:
	<input id="inicialPersonasAfectadas" name="inicialPersonasAfectadas" title="Personas afectadas" maxlength="30" size="30" type="text" value="0"/>
	<br/>
	<br/>	
...
<?php
	...
	comboQueryJSMultiple($query,"ID_TURNO", 'NOMBRE', 'inicialAutoresTurno', 'inicialAutores', 'autores', 'Seleccionar turno','Autores');
