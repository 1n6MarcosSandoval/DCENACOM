...
<h1>Sistema de captura</h1>
		...
		<div class="left">
			...
			<div class="lboxForm">
	<h2>Reporte de tipo Seguimiento a <?php echo $_GET["cr"]; ?></h2>
...
<?php
	$seguimientoEstado=obtenerValorQuery($conOracle,'CENACOM', 'REPORTES', 'CR', $_GET["cr"], 'ESTADO');
	$seguimientoMunicipio=obtenerValorQuery($conOracle,'CENACOM', 'REPORTES', 'CR', $_GET["cr"], 'MUNICIPIO');
	$seguimientoLocalidad=obtenerValorQuery($conOracle,'CENACOM', 'REPORTES', 'CR', $_GET["cr"], 'LOCALIDAD');
	$seguimientoOtroLugar=obtenerValorQuery($conOracle,'CENACOM', 'REPORTES', 'CR', $_GET["cr"], 'OTRO_LUGAR');
	$seguimientoClasificacionFenomeno=obtenerValorQuery($conOracle,'CENACOM', 'REPORTES', 'CR', $_GET["cr"], 'CLASIFICACIONFENOMENO_ID');
	$seguimientoTipoFenomeno=obtenerValorQuery($conOracle,'CENACOM', 'REPORTES', 'CR', $_GET["cr"], 'TIPOFENOMENO_ID');
	$seguimientoFechaFenomenoM=obtenerValorFecha($conOracle,'CENACOM', 'REPORTES', 'CR', $_GET["cr"], 'FECHA_INICIO_FENOMENO');
...
?>
	...
	<br/>
	Personas afectadas:
	<input id="seguimientoPersonasAfectadas" name="seguimientoPersonasAfectadas" title="Personas afectadas" maxlength="30" size="30" type="text" value="0"/>
	<br/>
	<br/>	
