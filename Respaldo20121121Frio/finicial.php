...
$sql02="VALUES(";
$sql04=")";
$sql03=$idEvento.","."'INICIAL'".","."'1'".",".$inicialFechaHoraReportaSQL.",".$inicialFechaHoraReportaSQL.",'"."Sin resumen."."','".$inicialInstitucionesLista."','"."Sin resumen"."','"."NO"."'";
...
$sql1="INSERT INTO CENACOM.REPORTES(ID_REPORTE, CR, FECHA_REPORTE, EFECTO_ADVERSO, FECHA_AVISO, ORGANISMO_AVISO, AREAS_AFECTADAS, PERSONAS_AFECTADAS, MUERTOS, LESIONADOS, DESAPARECIDOS, EVACUADOS, LINEAS_VITALES, INFRAESTRUCTURA_DANADA, OBSERVACIONES, RESPUESTA_INSTITUCIONAL, LINK, ID_USUARIO, ID_EVENTO, ID_TIPO_REPORTE, CLASIFICACIONFENOMENO_ID, ESTADO, MUNICIPIO, LOCALIDAD, X, Y, TURNO, TIPOFENOMENO_ID, OTRO_LUGAR, CR_RELACIONADO, FECHA_INICIO_FENOMENO)";
$sql2="VALUES(";
$sql4=")";
...
$sql36=$_POST["inicialClasificacionFenomeno"]."',".$_POST["inicialEstado"].",".$_POST["inicialMunicipio"].",".$inicialLocalidad.",";
$sql37="0"." ,"."0"." ,".$_POST["inicialAutoresTurno"].",".$_POST["inicialTipoFenomeno"].",'".$inicialOtroLugar."' ,"."0"." ,".$inicialFechaHoraFenomenoSQL;
